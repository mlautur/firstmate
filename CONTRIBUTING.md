...
tests/fm-backend-dispatch.test.sh         # crew backend dispatcher: config/crew-backend selection, FM_CREW_BACKEND override, default/tmux seam wiring, herdr stub load-then-fail-loudly, unknown-backend rejection, fm_be_agent_status mapping
